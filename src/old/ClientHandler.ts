...
export class ClientHandler {
	...
	constructor(bb: BB) {
		bb.onEvent("ProtocolHandler.outs.connected.v", (msg: { clientId: number }) => {
		...
		bb.onEvent("ProtocolHandler.outs.call.c", (msg: { clientId: number, name: string; args: any }) => {
			console.log("CH.call", msg)

			bb.call("ClientHandler.outs."+ msg.name+".c", {clientId: msg.clientId, args: msg.args })
		})
		bb.onEvent("ProtocolHandler.outs.notify.v", (msg: { name: string; args: any }) => {
			console.log("CH: notify msg", msg)
		})
		bb.onEvent("ProtocolHandler.outs.disconnected.v", (msg) => {
